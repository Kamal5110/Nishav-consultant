        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 md:order-2 reveal reveal-delay-400" ref={imageRef}>
            <div className="grid grid-cols-6 grid-rows-6 gap-4 h-full">
              {/* Main image */}
              <div className="col-span-4 row-span-4 relative overflow-hidden rounded-lg shadow-xl">
              ...
              <div className="col-span-2 row-span-2 relative overflow-hidden rounded-lg shadow-md">
                <div className="absolute inset-0 bg-gradient-to-bl from-accent/30 to-primary/30 mix-blend-overlay"></div>
                <img 
              ...
              <div className="col-span-2 row-span-2 relative overflow-hidden rounded-lg shadow-md mt-auto">
              ...
              {/* Bottom left image */}
              <div className="col-span-3 row-span-2 relative overflow-hidden rounded-lg shadow-md">
                <div className="absolute inset-0 bg-gradient-to-tr from-accent/30 to-primary/30 mix-blend-overlay"></div>
                <img 
              ...
              {/* Bottom right image */}
              <div className="col-span-3 row-span-2 relative overflow-hidden rounded-lg shadow-md">
                <div className="absolute inset-0 bg-gradient-to-bl from-primary/30 to-accent/30 mix-blend-overlay"></div>
                <img 
